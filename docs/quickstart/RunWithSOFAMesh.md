...
注意，pilot 至少需要 2G 内存，所以在启动的时候，这里设置使用 8G 内存
...
访问 [http://127.0.0.1:8001/api/v1/namespaces/default/services/productpage:9080/proxy/productpage ](http://127.0.0.1:8001/api/v1/namespaces/default/services/productpage:9080/proxy/productpage) 正常的话会看到 BookInfo 的界面，
其中 Book Reviews 有三个版本，刷新后依次会看到(可以查看 samples/bookinfo/platform/kube/bookinfo.yaml 中的配置发现为什么是这三个版本)
+ 版本一 的界面
![](../images/v1.png)
...
再次访问 [http://127.0.0.1:8001/api/v1/namespaces/default/services/productpage:9080/proxy/productpage ](http://127.0.0.1:8001/api/v1/namespaces/default/services/productpage:9080/proxy/productpage) 发现 reviews 固定在如下版本一的页面不再变化
...
再次访问 [http://127.0.0.1:8001/api/v1/namespaces/default/services/productpage:9080/proxy/productpage ](http://127.0.0.1:8001/api/v1/namespaces/default/services/productpage:9080/proxy/productpage) 这次 v1 和 v3 各有 1/2 几率出现
...
```
访问 [http://127.0.0.1:8001/api/v1/namespaces/default/services/productpage:9080/proxy/productpage ](http://127.0.0.1:8001/api/v1/namespaces/default/services/productpage:9080/proxy/productpage) 时：
